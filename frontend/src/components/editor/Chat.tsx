  ...
  return (
    <div>
        ...
        <div className="flex justify-center">
            <div className="p-2 space-y-2 md:space-y-3 sm:p-2">
                <form onSubmit = {sendMessage} className="" action="#">
                <div >
                        <input  type="username" name="username" id="messageText" className="text-white border bg-transparent border-teal-400 focus:ring-teal-400 focus:ring-4 focus:outline-none  font-semibold rounded-lg text-md px-5 py-2.5 text-center me-2 mb-2 " placeholder="message"></input>
                        <button className="mx-auto text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-semibold rounded-lg text-sm px-5 py-2.5 text-center ">Send</button>
                </div>
